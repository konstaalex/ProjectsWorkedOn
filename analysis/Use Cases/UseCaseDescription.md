...
| Main success scenario | 1. A Customer wants to book a flight and gives the sales employee the information <br> 2. Sales employee looks if the flight is available or not <br> 3. System shows all flights which are similar to the search <br> 4. Sales employee is picking the searched flight <br> 5. System asks for information to the booking <br> 6. Sales employee gives the requested information and ends the booking <br> 7. System saves the information and gives a booking ID |
